...
const variantData: Record<string, Record<typeof states[number], StateData>> = {
  ...
  // Inverted: Tennis Ball Green bg — shown on dark row bg
  inverted: {
  ...
  // Inverted-secondary: shown on dark row bg; focus/pressed bg is white per Figma spec
  'inverted-secondary': {
  ...
  // Error: same bg all interactive states; hover darkened via brightness filter
  error: {
  ...
  return (
    <div className="min-h-screen p-[var(--space-xxl)]">
      <div className="max-w-[1200px] mx-auto">
        ...
        {/* Interactive controls — real buttons for live hover/focus testing */}
